...
def load_genome(input_file):
    ...
    sequence = ["" if line.startswith('>') else line for line in lines]
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='duplicating reads from the \
		input genomes')
    ...
    parser.add_argument('-n', action='store', dest='seq_num', required=True,
                        type=int, help='the number of output copies for each input sequence')
