...
# satisfy the converage and length distritubtion requirement
echo "Executing the preprocessing step..."
python2 ./sampling_from_genome/single_genome_duplicate.py \
	-i $FULLFILE \
	-p ./$FILENAME/sampled_read \
	-n 10 \
	-d 0 \
...
#  python2 ./sampling_from_genome/single_genome_duplicate.py -i ./test_samples/test.fasta -p ./test/sampled_read -n 10 -d -2 -c 0
